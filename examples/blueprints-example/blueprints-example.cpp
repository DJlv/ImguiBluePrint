...
#include <algorithm>
#include <utility>
#include <examples/blueprints-example/src/inc/Base_Node.h>
 ...
 */
    ...
    void DrawPinIcon(const Pin &pin, bool connected, int alpha) {
        ...
        ax::Widgets::Icon(ImVec2(static_cast<float>(m_PinIconSize), static_cast<float>(m_PinIconSize)), iconType,
...
# if 1
        ...
        if (ImGui::BeginPopup("Node Context Menu")) {
            ...
            if (node) {
                ...
                ImGui::Text("Type: %s",
                            node->Type == NodeType::Blueprint ? "Blueprint" : (node->Type == NodeType::Tree ? "Tree"
                                                                                                            : "Comment"));
