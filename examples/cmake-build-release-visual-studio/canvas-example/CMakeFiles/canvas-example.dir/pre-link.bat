@echo off
cd /D D:\node\project\ImguiBluePrint\examples\cmake-build-release-visual-studio\canvas-example || (set FAIL_LINE=2& goto :ABORT)
...
cd /D D:\node\project\ImguiBluePrint\examples\cmake-build-release-visual-studio\canvas-example || (set FAIL_LINE=4& goto :ABORT)
...
cd /D D:\node\project\ImguiBluePrint\examples\cmake-build-release-visual-studio\canvas-example || (set FAIL_LINE=6& goto :ABORT)
...
cd /D D:\node\project\ImguiBluePrint\examples\cmake-build-release-visual-studio\canvas-example || (set FAIL_LINE=8& goto :ABORT)
...
cd /D D:\node\project\ImguiBluePrint\examples\cmake-build-release-visual-studio\canvas-example || (set FAIL_LINE=10& goto :ABORT)
...
cd /D D:\node\project\ImguiBluePrint\examples\cmake-build-release-visual-studio\canvas-example || (set FAIL_LINE=12& goto :ABORT)
...
cd /D D:\node\project\ImguiBluePrint\examples\cmake-build-release-visual-studio\canvas-example || (set FAIL_LINE=14& goto :ABORT)
...
cd /D D:\node\project\ImguiBluePrint\examples\cmake-build-release-visual-studio\canvas-example || (set FAIL_LINE=16& goto :ABORT)
"C:\Program Files\JetBrains\CLion 2023.2.2\bin\cmake\win\x64\bin\cmake.exe" -E copy_if_different D:/node/project/ImguiBluePrint/examples/cmake-build-release-visual-studio/canvas-example/Resource.rc D:/node/project/ImguiBluePrint/examples/cmake-build-release-visual-studio/bin/data/../../cmake-build-release-visual-studio/canvas-example/Resource.rc || (set FAIL_LINE=17& goto :ABORT)
cd /D D:\node\project\ImguiBluePrint\examples\cmake-build-release-visual-studio\canvas-example || (set FAIL_LINE=18& goto :ABORT)
...
cd /D D:\node\project\ImguiBluePrint\examples\cmake-build-release-visual-studio\canvas-example || (set FAIL_LINE=20& goto :ABORT)
...
cd /D D:\node\project\ImguiBluePrint\examples\cmake-build-release-visual-studio\canvas-example || (set FAIL_LINE=22& goto :ABORT)
...
cd /D D:\node\project\ImguiBluePrint\examples\cmake-build-release-visual-studio\canvas-example || (set FAIL_LINE=24& goto :ABORT)
...
cd /D D:\node\project\ImguiBluePrint\examples\cmake-build-release-visual-studio\canvas-example || (set FAIL_LINE=26& goto :ABORT)
...
cd /D D:\node\project\ImguiBluePrint\examples\cmake-build-release-visual-studio\canvas-example || (set FAIL_LINE=28& goto :ABORT)
