...
ImProjectOnCubicBezier(const ImVec2 &point, const ImVec2 &p0, const ImVec2 &p1, const ImVec2 &p2, const ImVec2 &p3,
...
inline ImProjectResult
ImProjectOnCubicBezier(const ImVec2 &p, const ImCubicBezierPoints &curve, const int subdivisions) {
...
ImCubicBezierSubdivide(ImCubicBezierSubdivideCallback callback, void *user_pointer, const ImVec2 &p0, const ImVec2 &p1,
                       const ImVec2 &p2, const ImVec2 &p3, float tess_tol, ImCubicBezierSubdivideFlags flags) {
...
ImCubicBezierFixedStep(ImCubicBezierFixedStepCallback callback, void *user_pointer, const ImVec2 &p0, const ImVec2 &p1,
                       const ImVec2 &p2, const ImVec2 &p3, float step, bool overshoot, float max_value_error,
                       float max_t_error) {
...
ImCubicBezierFixedStep(F &callback, const ImVec2 &p0, const ImVec2 &p1, const ImVec2 &p2, const ImVec2 &p3, float step,
                       bool overshoot, float max_value_error, float max_t_error) {
...
template<typename F>
inline void
ImCubicBezierFixedStep(F &callback, const ImCubicBezierPoints &curve, float step, bool overshoot, float max_value_error,
                       float max_t_error) {
    auto handler = [](ImCubicBezierFixedStepSample &sample, void *user_pointer) {
        auto &callback = *reinterpret_cast<F *>(user_pointer);
        callback(sample);
