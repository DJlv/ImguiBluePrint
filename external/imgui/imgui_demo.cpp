        ...
        const char *item_names[] =
                {
                        ...
                        "InputFloat3", "ColorEdit4", "MenuItem", "TreeNode", "TreeNode (w/ double-click)", "Combo",
                        "ListBox"
                };
    ...
    if (ImGui::TreeNode("Stack Layout")) {
        ...
        struct funcs {
            static void VisibleSpring(float spring_weight) {
                ...
                if (fabsf(start_cursor_pos.x - end_cursor_pos.x) < 1.0f &&
                    fabsf(start_cursor_pos.y - end_cursor_pos.y) < 1.0f)
                    return;
        ...
        ImGui::Checkbox("Widget A", &widget_a);
        ImGui::SameLine();
        ImGui::Checkbox("Widget B", &widget_b);
        ImGui::SameLine();
        ImGui::Checkbox("Widget C", &widget_c);
        ImGui::Checkbox("Spring A", &spring_a);
        ImGui::SameLine();
        ImGui::Checkbox("Spring AB", &spring_ab);
        ImGui::SameLine();
        ImGui::Checkbox("Spring BC", &spring_bc);
        ImGui::SameLine();
        ImGui::Checkbox("Spring C", &spring_c);
        ImGui::Checkbox("Horizontal", &horizontal);
        ImGui::SameLine();
        ImGui::Checkbox("Minimize Width", &minimize_width);
        ImGui::SameLine();
        ...
        if (ImGui::IsItemHovered())
            ImGui::SetTooltip(
                    "This is vertical alignment for horizontal layouts and horizontal alignment for vertical layouts.");
        ...
        if (ImGui::TreeNode("Keyboard & Navigation State")) {
            ...
            for (int i = 0; i < IM_ARRAYSIZE(io.KeysDown); i++)
                if (ImGui::IsKeyDown(i)) {
                    ImGui::SameLine();
                    ImGui::Text("\"%s\" %d (0x%X) (%.02f secs)", ImGui::GetKeyName(ImGui::FindImGuiKey(i)), i, i,
            ...
            for (int i = 0; i < IM_ARRAYSIZE(io.KeysDown); i++)
                if (ImGui::IsKeyPressed(i)) {
                    ImGui::SameLine();
                    ImGui::Text("\"%s\" %d (0x%X)", ImGui::GetKeyName(ImGui::FindImGuiKey(i)), i, i);
                }
