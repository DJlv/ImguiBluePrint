        ...
        struct Config {
            ...
            Config()
                    : SettingsFile("NodeEditor.json"), BeginSaveSession(nullptr), EndSaveSession(nullptr),
                      ...
                      NavigateButtonIndex(1), ContextMenuButtonIndex(1), EnableSmoothZoom(false)
# ifdef __APPLE__
...
// TODO: Add a way to manage node background channels
        ...
        Link(LinkId id, PinId startPinId, PinId endPinId, const ImVec4 &color = ImVec4(1, 1, 1, 1),
        ...
        IMGUI_NODE_EDITOR_API bool
        QueryNewLink(PinId *startId, PinId *endId, const ImVec4 &color, float thickness = 1.0f);
        ...
        IMGUI_NODE_EDITOR_API void SetNodeZPosition(NodeId nodeId,
        ...
        IMGUI_NODE_EDITOR_API bool GetLinkPins(LinkId linkId, PinId *startPinId,
        ...
        IMGUI_NODE_EDITOR_API int
        GetNodeCount();                                // Returns number of submitted nodes since Begin() call
        IMGUI_NODE_EDITOR_API int GetOrderedNodeIds(NodeId *nodes,
